...
(test "tabularized seq (missing cell)" "\
┌───────────┐
│ 1 │ 2 │ 3 │
│ 4 │ 5 │ 6 │
│ 7 │ 8 │   │
└───────────┘
"
      (run "seq 8 | sad buffer 3 | sad tabularize"))
...
(test "tabularized seq (markdown, first line is header, missing cell)" "\
| 1 | 2 | 3 |
|---|---|---|
| 4 | 5 | 6 |
| 7 | 8 |   |
"
      (run "seq 8 | sad buffer 3 | sad tabularize --markdown --first-line-is-header"))
